...
public class AdminPerformanceUpdateHandler extends AbstractMenuHandler {
  MemberDao memberDao;
  AdminPerformanceDao adminPerformanceDao;

  public AdminPerformanceUpdateHandler(Prompt prompt, AdminPerformanceDao adminPerformanceDao,MemberDao memberDao) {
    super(prompt);
  ...
  protected void action() {
    ...
    performance.setNo(this.prompt.inputInt("수정할 공연 no? "));
    ...
    adminPerformanceDao.modify(performance);
